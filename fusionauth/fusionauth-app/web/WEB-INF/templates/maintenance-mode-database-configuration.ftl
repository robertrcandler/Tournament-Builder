      ...
      [@panel.full titleKey="page-title" rowClass="row center-xs" columnClass="col-xs col-lg-8"]
        [@control.form action="maintenance-mode-database-configuration" method="POST" class="labels-left full"]
          <fieldset>
            ...
            [@control.radio_list items=["mysql", "postgresql"] name="database.dbType"/]
          ...
          <fieldset>
            ...
            [@control.text name="rootUsername" autocapitalize="none" autocomplete="off" autocorrect="off" spellcheck="false" required=true/]
