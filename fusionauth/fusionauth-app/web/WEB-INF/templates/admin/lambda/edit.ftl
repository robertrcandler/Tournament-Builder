...
[@layout.html]
  ...
  [/@layout.head]
  [@layout.body]
    [@layout.pageForm action="edit/${lambdaId}" method="POST" id="lambda-form" panelTitleKey="" cancelURI="/admin/lambda/" breadcrumbs={"": "settings", "/admin/lambda/": "lambdas", "/admin/lambda/edit/${lambdaId}": "edit"}]
