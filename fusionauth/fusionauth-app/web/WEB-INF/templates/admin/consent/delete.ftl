...
[@layout.html]
  [@layout.head/]
  [@layout.body]
    [@layout.pageForm action="delete" method="POST" class="full" includeSave=true includeCancel=true cancelURI="/admin/consent/${consent.id}" saveColor="red" saveKey="delete" saveIcon="trash" breadcrumbs={"": "settings", "/admin/user-action/": "user-actions", "/admin/consent/delete/${consent.id}": "page-title"}]
