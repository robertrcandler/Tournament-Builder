...
[#macro formFields action]
  <fieldset>
    ...
    [/#if]
    [@control.text required=true name="consent.name" autofocus="autofocus" tooltip=message.inline('{tooltip}consent.name')/]
    ...
    [#list consents![] as consent]
      <tr>
        ...
        <td class="action">
          ...
          [@button.action href="/ajax/consent/view/${consent.id}" icon="search" key="view" color="green" ajaxView=true ajaxWideDialog=true/]
