...
[@layout.html]
  ...
  [/@layout.head]
  [@layout.body]
    [@layout.pageForm action="edit" method="POST" id="identity-provider-form" pageTitleKey="edit-${type}" includeSave=true includeCancel=true includeDelete=true cancelURI="/admin/identity-provider/" deleteURI="/admin/identity-provider/delete/${identityProviderId}" breadcrumbs={"": "settings", "/admin/identity-provider/": "identity-providers", "/admin/identity-provider/edit/${identityProviderId}": "edit"}]
