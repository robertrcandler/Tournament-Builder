...
[#macro confirm action key idField="" titleKey="title" idField2="" idField3="" ajaxSuccessURI="" includeFooter=false]
  [@basic titleKey=titleKey includeFooter=includeFooter]
    ...
    [/#if]
    [@control.form action=action method="POST" ajax=true ajaxSuccessURI=ajaxSuccessURI]
      <fieldset>
...
[#macro form action titleKey="title" includeFooter=false submitIcon="save" submitColor="blue" submitTextKey="submit" formClass="" id="" disableSubmit=false includeFooter=true]
