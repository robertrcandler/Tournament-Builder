...
[#--
 ...
 --]
[#macro rowEval nameKey object propertyName="" booleanAsCheckmark=true classes=""]
  [@row nameKey=nameKey value=display(object, propertyName, "\x2013", booleanAsCheckmark) classes=classes/]
[/#macro]
...
[#--
 ...
 --]
[#function display object propertyName default="\x2013", booleanAsCheckmark=true]
  ...
  [#if value?? && value?is_boolean]
    [#if booleanAsCheckmark]
      [#assign ret]
        [#noautoesc][@displayCheck value/][/#noautoesc]
      [/#assign]
      [#return ret]
    [#else]
...
[#function expiration start ttlInMinutes]
  [#return function.format_zoned_date_time(start.plusMinutes(ttlInMinutes), function.message('date-time-format'), zoneId)]
[/#function]

[#macro displayCheck value]
